...
generate_code_book(vlcRadio + 1, procImage, escape_prob);

function coding_table = generate_code_book(mode, arr, escape_prob)
% mode: 1-单符号      2-双符号 最后单符号码表的文件名为'table$mode$.txt'
% arr: Huffman编码的图片矩阵
% escpae_prob: 逃逸概率
